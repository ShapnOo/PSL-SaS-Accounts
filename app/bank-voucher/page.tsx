...
export default function BankVoucherPage() {
  ...
  const [entries, setEntries] = useState<BankEntry[]>(seedEntries)
        ...
        <div className="p-4 lg:p-6 space-y-6">
          ...
          <div className="rounded-xl border border-border/70 bg-card shadow-sm">
            ...
            <div className="grid gap-4 p-4 md:grid-cols-4">
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Cheque/Advice No</p>
                <Input
                  value={form.chequeNo}
                  onChange={(e) => setForm((prev) => ({ ...prev, chequeNo: e.target.value }))}
                  className="h-10 text-sm"
                  placeholder="Enter cheque/advice no"
                />
              </div>
              <div className="space-y-1">
          ...
          <div className="rounded-xl border border-border/70 bg-card shadow-sm">
            ...
            <div className="p-4">
              <div className="grid gap-3 md:grid-cols-5">
                ...
                <Input placeholder="Amount" className="h-10 text-sm text-right" />
                <select className="h-10 rounded-md border border-border/80 bg-white px-3 text-sm text-foreground shadow-sm">
