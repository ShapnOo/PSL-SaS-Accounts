...
const accountHeadOptions = ["Select account", "Cash", "Petty Cash"]
const supplierOptions = ["Select supplier", "Bengal Root", "Edison Footwear", "OMC Footwear"]
const accountOptions = ["Select account", "Cash", "Accounts Receivable", "Income - Service"]
const costCenterOptions = ["Select cost center", "General", "IT", "Sales"]

const seedEntries: ReceiveEntry[] = []

export default function CashReceivedVoucherPage() {
  ...
  const [entries, setEntries] = useState<ReceiveEntry[]>(seedEntries)
        ...
        <header className="sticky top-0 z-40 flex h-14 items-center justify-between gap-4 border-b border-border/40 bg-card/95 backdrop-blur-sm px-4 lg:px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-sm font-semibold text-foreground">Cash Received Voucher</h1>
            </div>
          </div>
        </header>
        ...
        <div className="p-4 lg:p-6 space-y-6">
          ...
          <div className="rounded-xl border border-border/70 bg-card shadow-sm">
            ...
            <div className="grid gap-4 p-4 md:grid-cols-4">
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">From</p>
                <Input
                  value={form.from}
