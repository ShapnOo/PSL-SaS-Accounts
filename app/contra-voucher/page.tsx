...
export default function ContraVoucherPage() {
  ...
  const [entries, setEntries] = useState<ContraEntry[]>(seedEntries)
        ...
        <header className="sticky top-0 z-40 flex h-14 items-center justify-between gap-4 border-b border-border/40 bg-card/95 backdrop-blur-sm px-4 lg:px-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-sm font-semibold text-foreground">Contra Voucher</h1>
            </div>
          </div>
        </header>
        ...
        <div className="p-4 lg:p-6 space-y-6">
          ...
          <div className="rounded-xl border border-border/70 bg-card shadow-sm">
            ...
            <div className="grid gap-4 p-4 md:grid-cols-4">
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Date (DD-MM-YYYY)</p>
              ...
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Last Transaction No</p>
                <Input
                  value={form.lastTransactionNo}
                  onChange={(e) => setForm((prev) => ({ ...prev, lastTransactionNo: e.target.value }))}
                  className="h-10 text-sm"
                  placeholder="Auto / previous"
                />
              </div>
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Bank Account Head</p>
                <Input
                  placeholder="Select account head"
                  value={form.bankAccountHead}
                  onChange={(e) => setForm((prev) => ({ ...prev, bankAccountHead: e.target.value }))}
                  className="h-10 text-sm"
                />
              </div>
              <div className="space-y-1">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-muted-foreground">Paid To</p>
                <Input
                  value={form.paidTo}
